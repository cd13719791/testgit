...
public class PrincipalTag extends SecureTag {
	 ...
	 * should be used.
	 */
	String getType(Map<Object, Object> params) {
	 ...
	 */
	String getProperty(Map<Object, Object> params) {
	...
	Object getPrincipalFromClassName(Map<Object, Object> params) {
	...
	String getPrincipalProperty(Object principal, String property) throws TemplateModelException {
		try {
			...
			throw new TemplateModelException("Error reading property [" + property + "] from principal of type [" + principal.getClass().getName()
					+ "]", ex);
		}
	}
}
